...
/**
 * Pons v2 ABIs. Struct shapes and event signatures were checked against the live contracts: the
 * topic0 values below match logs the factory and the curves actually emit.
 */
...
export const curveAbi = parseAbi([
  ...
  // The opening tax has its own event; CurveBuy's `tax` is the creator's standing tax.
...
/** The fee escrow. claim() pays msg.sender, so a contract recipient has to call it itself. */
 ...
 * opening tax for, decoded from the launch transaction's input.
 */
